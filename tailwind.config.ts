  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "progress-tier-group-1": "hsl(var(--progress-tier-group-1))",
        "progress-tier-group-2": "hsl(var(--progress-tier-group-2))",
      ...
      animation: {
        ...
        "slide-in-from-left":
          "slide-in-from-left 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "slide-in-from-right":
          "slide-in-from-right 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards",
      },
    },
  },
